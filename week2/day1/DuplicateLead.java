...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Thillai Nandhini");
		...
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Thillai");
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("letsmailthillainandhini@gmail.com");
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Thillai");
