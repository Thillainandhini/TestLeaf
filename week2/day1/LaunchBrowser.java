...
public class LaunchBrowser {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("ThillaiNandhini");// enter First Name
		
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Nandhini");// enter Last Name
		...
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Thillai");// enter Local Name
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("letsmailthillainandhini@gmail.com");// Enter E-mail id
																										
		WebElement raw = driver.findElement(By.id("createLeadForm_generalStateProvinceGeoId"));// raw name can be any name
